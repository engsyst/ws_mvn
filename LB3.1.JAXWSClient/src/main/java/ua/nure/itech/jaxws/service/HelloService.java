 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://service.jaxws.itech.nure.ua/", wsdlLocation = "http://localhost:9090/hello?wsdl")
public class HelloService extends Service {
	...
	public Hello getHelloPort() {
		return super.getPort(new QName("http://service.jaxws.itech.nure.ua/", "HelloPort"), Hello.class);
	}
	...
	public Hello getHelloPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://service.jaxws.itech.nure.ua/", "HelloPort"), Hello.class, features);
	}
