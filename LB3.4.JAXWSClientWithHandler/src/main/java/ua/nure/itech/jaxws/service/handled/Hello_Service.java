 ...
 * 
 */
@WebServiceClient(name = "Hello", targetNamespace = "http://handled.service.jaxws.itech.nure.ua/", wsdlLocation = "http://localhost:9090/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLO_QNAME = new QName("http://handled.service.jaxws.itech.nure.ua/", "Hello");
